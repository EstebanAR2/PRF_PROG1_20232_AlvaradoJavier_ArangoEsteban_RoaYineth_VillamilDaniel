...
/**
 * La clase ModifyBetPlayWindow2 representa la segunda ventana de modificación para la apuesta de juegos.
 */
public class ModifyBetPlayWindow2 extends JLayeredPane{

	/**Número de serie único para la serialización. */
	private static final long serialVersionUID = 4283987169462527917L;
    /** Imagen de fondo de la ventana. */
    private JLabel backg;
    /** El botón para volver al menú anterior. */
    private JButton back;
    /** El botón para actualizar la apuesta. */
    private JButton update;
    /** El campo de texto para la cantidad de la apuesta. */
    private JTextField betValue;
    /** La lista de equipos para los enfrentamientos. */
    private ArrayList<String> equipos, equipos2, equipos3, equipos4;
    /** Las etiquetas que representan los enfrentamientos. */
    private ArrayList<JLabel> labelsEnfrentamientos, labelsEnfrentamientos2, labelsEnfrentamientos3, labelsEnfrentamientos4;
    /** Los selectores de resultados para los partidos de fútbol. */
    private JSpinner resultado, resultado2, resultado3, resultado4, resultado5, resultado6, resultado7, resultado8, resultado9, resultado10, resultado11, resultado12, resultado13, resultado14;
    /** Los modelos de selección para los resultados. */
    private SpinnerListModel spinnerModel, spinnerModel2, spinnerModel3, spinnerModel4, spinnerModel5, spinnerModel6, spinnerModel7, spinnerModel8, spinnerModel9, spinnerModel10, spinnerModel11, spinnerModel12, spinnerModel13, spinnerModel14;

    /**
     * Construye una nueva instancia de la clase ModifyBetPlayWindow2.
     * Configura y muestra la segunda ventana de modificación para la apuesta de juegos.
     */
    public ModifyBetPlayWindow2() {
 		setBounds(0, 0, 1280, 720);
 		setLayout(null);

 		backg = new JLabel(new ImageIcon("src/Imagenes/22.png"));
 		...
 		update = new JButton();
 		update.setToolTipText("Click aqui para actualizar la apuesta");
 		update.setBounds(805, 610, 220, 60);
